...
import ActivityMobile  from '@/src/features/(business)/activity/views/mobile'
import ActivityDesktop from '@/src/features/(business)/activity/views/desktop'
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="lg:ml-64">
        {isDesktop ? <ActivityDesktop /> : <ActivityMobile />}
      </div>
      <Navbar />
    </div>
  )

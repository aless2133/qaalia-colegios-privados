...
import AssistantMobile  from '@/src/features/(business)/assistant/views/mobile'
import AssistantDesktop from '@/src/features/(business)/assistant/views/desktop'
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="lg:ml-64">
        {isDesktop ? <AssistantDesktop /> : <AssistantMobile />}
      </div>
      <Navbar />
    </div>
  )

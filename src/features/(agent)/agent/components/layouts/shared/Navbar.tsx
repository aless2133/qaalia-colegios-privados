            ...
            >
             ...
             <div className="absolute inset-x-0 flex justify-center px-12 pointer-events-none">
              <button
                ...
                className="pointer-events-auto flex items-center gap-1 max-w-full px-2 py-1 rounded-full hover:bg-muted/60 transition-colors disabled:pointer-events-none"
              >
          ...
          <nav className="flex flex-col gap-1 px-3 py-3">
            {secciones.map(({ id, label, icon: Icono, activo, onClick }) => (
              <button
                ...
                ${activo ? 'bg-primary/10 text-primary' : 'text-foreground hover:bg-muted/60'}`}
              >
